...
<div style="width: 270px;">
   ...
   <div style="cursor: pointer;">
      <ul>
         ...
         <li><label onClick="window.open('./approvalFormCreated','결재 양식 생성','width=900, height=1200, toolbar=no, menubar=no, scrollbars=yes, resizable=yes');return false;">양식추가</label></li>
         <li>
